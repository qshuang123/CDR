...
def basemodel_position(drop,embedding_matrix,max_sentence_length,max_sentence_number):
    ...
    entity1_atten = concatenate([entity1_atten, context_rep])
    entity2_atten = concatenate([entity2_atten, context_rep])
...
if __name__ == "__main__":
    ...
    logging.info('basemodel+position+entity_mask_ESIM32')
