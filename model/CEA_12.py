...
if __name__ == "__main__":
    ...
    for k in top_k:
        logging.info('basemodel+position+entity_mask_ESIM12_top_' + str(k))
        model = basemodel_position(0.3, embedding_matrix, 200, 23, k)
        run(model, train_x, train_y, dev_x, dev_y, test_x, test_y, train_pos1, dev_pos1, test_pos1, train_pos2,
            dev_pos2, test_pos2,
            train_entity1_pos, dev_entity1_pos, test_entity1_pos, train_entity2_pos, dev_entity2_pos, test_entity2_pos)
