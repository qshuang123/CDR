...
def skip(context_rep,entity1_rep,entity2_rep,k):
    for i in range(k):
        context_rep = concatenate([context_rep, entity1_rep, entity2_rep])
        context_rep = Dense(512)(context_rep)
        entity1 = Dense(512)(entity1_rep)
        entity1_rep = Add()([context_rep,entity1])
        entity2 = Dense(512)(entity2_rep)
        entity2_rep = Add()([context_rep, entity2])
...
def basemodel_position(drop,embedding_matrix,max_sentence_length,max_sentence_number):
    ...
    context_rep, entity1_rep, entity2_rep = skip(context_rep,entity1_rep,entity2_rep,1)
...
if __name__ == "__main__":
    ...
    logging.info('basemodel+position+entity_mask_ESIM5')
