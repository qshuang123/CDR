...
def basemodel_position(drop,embedding_matrix,max_sentence_length,max_sentence_number):
    ...
    entity1_embed = Lambda(entity_attention, output_shape=entity_attention_output_shape)([entity1_mask, lstm])
    entity2_embed = Lambda(entity_attention, output_shape=entity_attention_output_shape)([entity2_mask, lstm])

    out = concatenate([entity1_embed, entity2_embed])
...
if __name__ == "__main__":
    ...
    logging.info('basemodel+position+entity_mask_concatenate+elu')
