...
def basemodel_position(drop,embedding_matrix,max_sentence_length,max_sentence_number):
    ...
    entity1_out = concatenate([entity1_lstm, entity2_atten, submult(entity1_lstm,entity2_atten)])
    entity2_out = concatenate([entity2_lstm, entity1_atten, submult(entity2_lstm, entity1_atten)])

    entity1_out = GlobalMaxPooling1D()(entity1_out)
    entity2_out = GlobalMaxPooling1D()(entity2_out)
...
if __name__ == "__main__":
    ...
    logging.info('basemodel+position+entity_mask_ESIM')
